...
def create_nuscenes_infos(root_path,
    ...
    if test:
        ...
        info_path = osp.join(out_path,
                             '{}_map_infos_temporal_long_range_test_v2.pkl'.format(info_prefix))
        ...
        data = dict(infos=train_nusc_infos, metadata=metadata)
        info_path = osp.join(out_path,
                             '{}_map_infos_temporal_long_range_train_v2.pkl'.format(info_prefix))
        mmcv.dump(data, info_path)
        data['infos'] = val_nusc_infos
        info_val_path = osp.join(out_path,
                                 '{}_map_infos_temporal_long_range_val_v2.pkl'.format(info_prefix))
...
parser.add_argument('--extra-tag', type=str, default='nuscenes_long_range')
parser.add_argument(
